...
const CONFIG_HINTS = {
  ...
  'ocr.vlmEndpoint': 'Vision LLM のOpenAI互換エンドポイント（Qwen2.5-VL等）',
  'ocr.vlmModel': 'リクエストの model フィールド',
  ...
  'ocr.pdfToImageCmd': 'PDF→PNG変換コマンド（poppler-utils の pdftoppm）',
  'ocr.pdfInfoCmd': 'ページ数取得コマンド（poppler-utils の pdfinfo）',
