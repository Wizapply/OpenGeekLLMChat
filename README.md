...
**すぐ使える4テンプレート**（エディタからワンクリックで雛形生成）
...
> ⚠️ マルチLLM選択中は Web検索・RAG・ファイル操作などのツール実行と画像添付は使えません。ツールが必要な質問は単一モデルに切り替えてください。
...
- Web検索・RAG・ファイル操作などの **ツール実行と画像添付はマルチLLM選択中は使えません**。ツールが要る質問は単一モデルに切り替えてください
